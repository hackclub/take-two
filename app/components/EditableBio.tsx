    ...
    return (
        <div className="space-y-2">
            <textarea
                ...
                rows={2}
                autoFocus
                className="w-full text-sm bg-grub-bg1 border border-grub-bg3 text-grub-fg rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-grub-red focus:border-transparent resize-none placeholder-grub-fg4"
