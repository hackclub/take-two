...
export default function DashboardError() {
  return (
    <main className="max-w-5xl mx-auto px-6 py-8 text-center space-y-4">
      <h1 className="text-2xl font-semibold text-grub-fg0">Something went wrong</h1>
      <p className="text-sm text-grub-fg4">Failed to load the dashboard. This usually resolves on its own.</p>
      <button
